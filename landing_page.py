...
def download_file(platform):
    ...
    if os.path.exists(filepath):
        ...
        flash('Download file not ready yet. Please try the web version!', 'info')
        return redirect(url_for('web_version'))

@landing_app.route('/web')
def web_version():
    """Redirect to web version"""
    return redirect('https://your-app.onrender.com')  # Update this after deployment
